...
public class MemberDTO {
	...
	public MemberDTO(String user_email, String user_pw, String user_name, String user_nickname, String user_phone, String user_bd, String user_gender, String user_job, String user_intro, String user_image, String user_blacklist, String user_delete) {
		super();
	...
	public String toString() {
		return user_email + " : " + user_pw + " : " + user_name + " : " + user_nickname + " : " + user_phone + " : " + user_bd + " : " + user_gender + " : " + user_job + " : " + user_intro + " : " + user_image + " : " + user_blacklist + " : " + user_delete;
	}
