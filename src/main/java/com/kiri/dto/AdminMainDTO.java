...
public class AdminMainDTO {
	...
	public AdminMainDTO(int seq_group_cal, int seq_group, String user_email, String title, String start, String gcal_name, String gcal_content, String gcal_place, String gcal_latitude, String gcal_longitude, String group_title, String group_cal_cnt) {
		super();
	...
	public String toString() {
		return "AdminMapDTO [seq_group_cal=" + seq_group_cal + ", seq_group=" + seq_group + ", user_email=" + user_email + ", title=" + title + ", start=" + start + ", gcal_name=" + gcal_name + ", gcal_content=" + gcal_content + ", gcal_place=" + gcal_place + ", gcal_latitude=" + gcal_latitude + ", gcal_longitude=" + gcal_longitude + ", group_title=" + group_title + ", group_cal_cnt=" + group_cal_cnt + "]";
	}
