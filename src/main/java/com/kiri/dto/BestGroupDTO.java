...
public class BestGroupDTO {
	...
	public BestGroupDTO(int seq_group, String user_email, String group_title, String group_info, String group_category, String group_site, int group_people, String ori_name, String sys_name, int cnt) {
		super();
	...
	public String toString() {
		return "BestGroupDTO [seq_group=" + seq_group + ", user_email=" + user_email + ", group_title=" + group_title + ", group_info=" + group_info + ", group_category=" + group_category + ", group_site=" + group_site + ", group_people=" + group_people + ", ori_name=" + ori_name + ", sys_name=" + sys_name + ", cnt=" + cnt + "]";
	}
