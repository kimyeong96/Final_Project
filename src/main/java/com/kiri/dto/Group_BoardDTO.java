...
public class Group_BoardDTO {
	...
	public Group_BoardDTO(int seq_group_board, int seq_group, String user_email, String user_nickname, String gboard_category, String gboard_title, String gboard_content, Date written_date, int view_count, int likehit) {
		super();
	...
	public String toString() {
		return "Group_BoardDTO [seq_group_board=" + seq_group_board + ", seq_group=" + seq_group + ", user_email=" + user_email + ", user_nickname=" + user_nickname + ", gboard_category=" + gboard_category + ", gboard_title=" + gboard_title + ", gboard_content=" + gboard_content + ", written_date=" + written_date + ", view_count=" + view_count + ", likehit=" + likehit + "]";
	}
