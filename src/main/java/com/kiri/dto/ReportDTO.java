...
public class ReportDTO {
	...
	public ReportDTO(int seq_report, String send_email, String receive_email, String report_send, String report_receive, String report_reason, String report_date) {
		super();
	...
	public String toString() {
		return "ReportDTO [seq_report=" + seq_report + ", send_email=" + send_email + ", receive_email=" + receive_email + ", report_send=" + report_send + ", report_receive=" + report_receive + ", report_reason=" + report_reason + ", report_date=" + report_date + "]";
	}
