...
public class Group_Board_LikeDTO {
	...
	public Group_Board_LikeDTO(int seq_gboard_like, int seq_group_board, int seq_group, String user_email, int gboard_likecheck) {
		super();
	...
	public String toString() {
		return "Group_Board_LikeDTO [seq_gboard_like=" + seq_gboard_like + ", seq_group_board=" + seq_group_board + ", seq_group=" + seq_group + ", user_email=" + user_email + ", gboard_likecheck=" + gboard_likecheck + "]";
	}
}
