...
public class BoardController {
	...
	public String noticeWrite(BoardDTO dto, @RequestParam(value = "imgs[]", required = false) String[] imgs) throws Exception {
		String user_email = ((MemberDTO) session.getAttribute("loginSession")).getUser_email();
		String user_nickname = ((MemberDTO) session.getAttribute("loginSession")).getUser_nickname();
		dto.setUser_email(user_email);
		dto.setUser_nickname(user_nickname);
	...
	public String toDetailView(int seq_board, HttpServletRequest request, HttpServletResponse response, Model model, Criteria cri) throws Exception {
		// 조회수
