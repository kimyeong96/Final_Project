...
public class SignupContoller {
	...
	@RequestMapping("/signup")
	public String signup(MemberDTO dto, MultipartFile file, HttpSession session, String type, @RequestParam("hobby") List<String> hobby, @RequestParam("area") List<String> area) throws Exception { // 회원가입 feat.조용진
