...
public class HomeController {
	...
	public String main(Model model) throws Exception {
		session.setAttribute("kakaoLogout", "https://kauth.kakao.com/oauth/logout?client_id=" + SecurityInfo.kakaoId + "&logout_redirect_uri=" + "http://192.168.20.21/login/toLogout");
