			...
			<div id="userInfoBox">
				...
				<div class="row emailRow">
					...
					<div class="col-md-3 pr-0">
						<input type="text" id="email-id" name="email" class="form-control"> <span style="color: black; font-size: 15px;">@</span>
					</div>
					<div class="col-md-2" style="text-align: left">
						...
						<div class="email-domain-row mt-1">
							<div class="col-md-10 p-0">
								<input type="text" id="email-domain" name="email-domain" class="form-control m-0 p-1" value="1"> <input type="hidden" id="user_email" name="user_email" />
							</div>
							<div class="col-md-2">
				...
				<div class="row">
					...
					<div class="col-md-7 text-align-left-col">
						<span class="condition"> *한글, 영어, 숫자, !, @, #, $을 사용하여 최소 8, 최대 20자리까지 설정해주세요. </span>
					</div>
					<div class="col-2 text-align-left-col"></div>
				</div>
				<div class="row">
