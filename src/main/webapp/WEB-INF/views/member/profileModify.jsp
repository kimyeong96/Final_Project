		...
		<form action="/mem/profileModify" method="post" id="profileModifyForm">
			<div id="userInfoBox">
				...
				<div class="row">
					...
					<div class="col-md-5">
						<input type="text" id="nickname" name="user_nickname" class="form-control user_nickname" value="${memberdto.user_nickname}" placeholder="닉네임은 12자까지 가능합니다" maxlength="12">
					</div>
					<div class="col-md-2">
				...
				<div class="row">
					...
					<div class="col-md-7">
						<input type="text" name="year" class="form-control bthday" maxlength="4" value="${date.get(0)}" style="width: 140px;" readonly> <label for="year">년</label> <input type="text" name="month" class="form-control bthday" maxlength="2" value="${date.get(1)}" style="width: 130px;" readonly> <label for="month">월</label> <input type="text" name="day" class="form-control bthday" maxlength="2" value="${date.get(2)}" style="width: 130px;" readonly> <label for="day">일</label> <input type="text" id="user_bd" name="user_bd" class="form-control d-none" value="${memberdto.user_bd}">
				...
				<c:if test="${loginType eq 'general'}">
					<div class="row">
						...
						<div class="col-md-7" style="text-align: left;">
							<input type="password" id="password" name="user_pw" class="form-control" style="font-family: none;"> <span class="d-none" id="wrong-password-regex" style="color: red; font-size: 0.8rem; margin-left: 8px;">** 비밀번호의 형식에 맞지 않습니다. **</span>
					...
					<div class="row">
						...
						<div class="col-md-7" style="text-align: left;">
							<input type="password" id="password-check" class="form-control" style="font-family: none;"> <span class="d-none" id="wrong-password-check" style="color: red; font-size: 0.8rem; margin-left: 8px;">** 비밀번호와 맞지 않습니다. **</span> <span class="d-none" id="right-password-check" style="color: green; font-size: 0.8rem; margin-left: 8px;">** 비밀번호와 일치합니다. **</span>
						</div>
						<div class="col-2"></div>
					</div>
				</c:if>
				...
				<c:if test="${loginType ne 'general'}">
					<div class="row d-none">
						...
						<div class="col-md-7" style="text-align: left;">
							<input type="password" id="password" name="user_pw" class="form-control" style="font-family: none;" disabled> <span class="d-none" id="wrong-password-regex" style="color: red; font-size: 0.8rem; margin-left: 8px;">** 비밀번호의 형식에 맞지 않습니다. **</span> <span style="color: red; font-size: 0.8rem; padding: 10px">** 소셜로 로그인하시면 비밀번호 수정이 안됩니다 ** </span>
						</div>
						<div class="col-2"></div>
					</div>
					<div class="row d-none">
						...
						<div class="col-md-7" style="text-align: left;">
							<input type="password" id="password-check" class="form-control d-none" style="font-family: none;" disabled> <span class="d-none" id="wrong-password-check" style="color: red; font-size: 0.8rem; margin-left: 8px;">** 비밀번호와 맞지 않습니다. **</span> <span class="d-none" id="right-password-check" style="color: green; font-size: 0.8rem; margin-left: 8px;">** 비밀번호와 일치합니다. **</span>
						</div>
						<div class="col-2"></div>
					</div>
				</c:if>
				...
				<div class="row">
					...
					<div class="col-md-7">
						<input type="text" id="email-id" class="form-control email" style="text-align: center; width: 100%;" value="${memberdto.user_email}" readonly> <input type="text" id="email-domain" name="user_email" class="form-control d-none" value="${memberdto.user_email}" readonly>
						<div style="text-align: start;">
				...
				<div class="row">
					...
					<div class="col-md-5">
						...
						</select> <input type="text" id="phone2" class="form-control" style="text-align: center;" maxlength="4" value="${phone.get(1)}"> <input type="text" id="phone3" class="form-control" style="text-align: center;" maxlength="4" value="${phone.get(2)}"> <input type="text" class="checkPhone1 d-none" value="${phone.get(0)}"> <input type="text" class="checkPhone2 d-none" value="${phone.get(1)}"> <input type="text" class="checkPhone3 d-none" value="${phone.get(2)}"> <input type="text" class="checkPhone d-none" value="${memberdto.user_phone}"> <input type="text" class="d-none" name="user_phone">
					</div>
					<div class="col-md-2">
				...
				<div class="row justify-content-center">
					...
					<div class="col-md-7">
						<input type="text" id="gender" name="user_gender" class="form-control gender" style="text-align: center;" value="${memberdto.user_gender}" readonly>
						<div style="text-align: start;">
		...
		<div id="userInfoBox-profile">
			<div class="row">
				...
				<div class="col-8" style="text-align: left;">
					<input type="radio" class="job" id="student" name="job"><label for="student">학생</label> <input type="radio" class="job" id="employee" name="job"><label for="employee">회사원</label> <input type="radio" class="job" id="unemployed" name="job"><label for="unemployed">무직</label> <input type="radio" class="job" id="selectJob" name="job"><label for="selectJob">기타</label>
				</div>
				<div class="col-1"></div>
			</div>
		</div>
