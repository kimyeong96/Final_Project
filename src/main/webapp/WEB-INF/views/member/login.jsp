...
.findPw-emailCheck-box>.col-md-3, .findPw-emailCheck-box>.col-md-5,
	.findPw-emailCheck-box>.col-md-4 {
	display: inline-block;
}
	...
	<div class="container loginBox">
		...
		<form id="generalLogin" action="/login/general" method="post">
			<div id="loginForm">
				...
				<div class="row m-3">
					<div class="col-12">
						<p data-bs-toggle="modal" data-bs-target="#staticBackdrop1" class="search">아이디 찾기&emsp;</p>
						<span>/</span>
						<p data-bs-toggle="modal" data-bs-target="#staticBackdrop2" class="search">&emsp;비밀번호 찾기</p>
					</div>
				</div>
				<div class="row">
					<div class="col">
				...
				<div class="row socialRow justify-content-center align-items-center">
					<a class="social" id="kakaoBtn" target="_parent"><img class="social-img" src="/resources/images/kakoLogo.JPG" alt="오류가 발생했습니다."></a> <a class="social" href="${naverUrl}&auth_type=reauthenticate" target="_parent"><img class="social-img" src="/resources/images/naverLogo.JPG" alt="오류가 발생했습니다."></a>
					<div class="social d-flex align-items-center" onclick="location.href='/signup/toSignupAgree'">
						<span>회원가입</span>
					</div>
				</div>
			</div>
						...
						<div id="findId_body" class="modal-body">
							<div class="row find-box m-2">
								...
								<div class="col-md-9 d-flex justify-content-center">
									<input type="text" class="form-control" placeholder="ex) 홍길동" name="findId_name" id="findId_name">
								</div>
							</div>
							<div class="row find-box m-2 mt-4">
								...
								<div class="col-md-9 d-flex justify-content-center">
									<input type="text" id="find_phone" name="find_phone" class="form-control" placeholder="ex) 01012341234" maxlength="11">
								</div>
							</div>
							<div class="row find-box btns mt-4">
								<div class="col-md-12">
									<button type="button" class="btn" id="btnFindId">아이디 찾기</button>
								</div>
							</div>
							<div class="row findId-box m-2 mt-4">
								...
								<div class="col-md-5 " id="findId-col"></div>
					...
					<form id="findPwForm">
						<div id="findPw_body" class="modal-body">
							...
							<div class="row find-box mt-4">
								<div class="col-12 d-flex justify-content-center">
									<button type="button" class="btn" id="btnFindPW" style="background-color: #18365291; color: white;">비밀번호찾기</button>
								</div>
							</div>
						</div>
						<div class="row findPw-emailCheck-box m-2 justify-content-center">
							...
							<div class="col-md-4">
								<button type="button" class="btn btn-outline-secondary" id="findPw-emailCheck-btn">인증번호 입력</button>
							</div>
						</div>
					</form>
