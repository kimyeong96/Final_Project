			...
			<div id="userInfoBox">
				...
				<div class="row">
					...
					<div class="col-md-7">
						...
						<input type="text" id="user_name" name="user_name" value="${socialUser.user_name}" class="form-control" readonly="readonly"> <input type="hidden" id="user_pw" name="user_pw" value="" class="form-control" readonly="readonly"> <input type="hidden" id="type" name="type" value="" class="form-control" readonly="readonly">
					</div>
					<div class="col-2"></div>
				</div>
				<div class="row">
				...
				<div class="row">
					...
					<div class="col-md-7 text-align-left-col">
						<span class="condition"> *한글, 영어, 숫자을 사용하여 최소 2, 최대 12자리까지 설정해주세요. 숫자만 이용, l,i반복의 바코드형식의 닉네임은 제한됩니다. </span>
					</div>
					<div class="col-2 text-align-left-col"></div>
				</div>
				<div class="row">
					<div class="col-md-3"></div>
					<div class="col-md-7 text-align-left-col" id="nickname-col"></div>
					<div class="col-2 text-align-left-col"></div>
				</div>
				<div class="row">
					<div class="col-md-3">
					...
					<div class="col-md-9 d-flex justify-content start align-items-center">
						<input type="text" id="year" name="year" class="form-control bthday" maxlength="4" required><label for="year">년</label> <input type="text" id="month" name="month" class="form-control bthday" maxlength="2" placeholder="ex)01" required><label for="month">월</label> <input type="text" id="day" name="day" class="form-control bthday" maxlength="2" placeholder="ex)01" required><label for="day">일</label> <input type="hidden" id="user_bd" name="user_bd" class="form-control">
						</intput>
					</div>
				</div>
				<div class="row">
					...
					<div class="col-md-5" style="text-align: left;">
						...
						</select> <input type="text" id="phone2" name="phone2" class="form-control" maxlength="4" required> <input type="text" id="phone3" name="phone3" class="form-control" maxlength="4" required> <input type="hidden" id="user_phone" name="user_phone">
					</div>
					<div class="col-md-2">
				...
				<div class="row justify-content-center">
					...
					<div class="col-md-7">
						<input class="user_gender" type="radio" id="men" name="user_gender" value="남자" required> <label for="men">남자</label> <input class="user_gender" type="radio" id="women" name="user_gender" value="여자" required> <label for="women">여자</label>
					</div>
					<div class="col-2"></div>
				</div>
				<div class="row">
			...
			<div id="userInfoBox-profile">
						...
						<c:choose>
							<c:when test="${not empty socialUser.user_image}">
								<div class="profile_imgContainer">
									<img id="p_img" name="p_img" src="${socialUser.user_image}" alt="오류가 발생했습니다.">
								</div>
							</c:when>
							<c:otherwise>
								<div class="profile_imgContainer">
				...
				<div class="row">
					...
					<div class="col-8" style="text-align: left;">
						<input type="radio" class="user_job" id="student" name="user_job" value="학생"><label for="student">학생</label> <input type="radio" class="user_job" id="employee" name="user_job" value="회사원"><label for="employee">회사원</label> <input type="radio" class="user_job" id="unemployed" name="user_job" value="무직"><label for="unemployed">무직</label> <input type="radio" class="user_job" id="other" name="user_job" value="기타"><label for="other">기타</label>
					</div>
					<div class="col-1"></div>
				</div>
				<div class="row checkBox">
					...
					<div class="col-9">
						<div class="row">
							<div class="col">
								<input type="checkbox" id="travel" name="hobby" class="checkbox" value="아웃도어/여행"><label for="travel">아웃도어/여행</label> <input type="checkbox" id="sports" name="hobby" class="checkbox" value="운동/스포츠"><label for="sports">운동/스포츠</label> <input type="checkbox" id="fgn-language" name="hobby" class="checkbox" value="외국어/언어"><label for="sports">외국어/언어</label> <input type="checkbox" id="pets" name="hobby" class="checkbox" value="반려동물"><label for="pets">반려동물</label>
							</div>
						</div>
						<div class="row">
							<div class="col">
								<input type="checkbox" id="music" name="hobby" class="checkbox" value="음악/악기"><label for="music">음악/악기</label> <input type="checkbox" id="making" name="hobby" class="checkbox" value="공예/만들기"><label for="making">공예/만들기</label> <input type="checkbox" id="dance" name="hobby" class="checkbox" value="댄스/무용"><label for="dance">댄스/무용</label> <input type="checkbox" id="reading" name="hobby" class="checkbox" value="인문학/책/글"><label for="reading">인문학/책/글</label>
							</div>
						</div>
						<div class="row">
							<div class="col">
								<input type="checkbox" id="photographic" name="hobby" class="checkbox" value="사진/영상"><label for="photographic">사진/영상</label> <input type="checkbox" id="game" name="hobby" class="checkbox" value="게임/오락"><label for="game">게임/오락</label> <input type="checkbox" id="cooking" name="hobby" class="checkbox" value="요리/제조"><label for="cooking">요리/제조</label> <input type="checkbox" id="culture" name="hobby" class="checkbox" value="문화/공연/축제"><label for="culture">문화/공연/축제</label>
							</div>
						</div>
					</div>
				</div>
				<div class="row checkBox">
					...
					<div class="col-9">
						<div class="row">
							<div class="col">
								<input type="checkbox" id="seoul" name="area" class="checkbox" value="서울"><label for="seoul">서울</label> <input type="checkbox" id="incheon" name="area" class="checkbox" value="인천"><label for="incheon">인천</label> <input type="checkbox" id="gyeonggi-do" name="area" class="checkbox" value="경기도"><label for="gyeonggi-do">경기도</label> <input type="checkbox" id="gangwon-do" name="area" class="checkbox" value="강원도"><label for="gangwon-do">강원도</label>
							</div>
						</div>
						<div class="row">
							<div class="col">
								<input type="checkbox" id="chungcheong-do" name="area" class="checkbox" value="충청도"><label for="chungcheong-do">충청도</label> <input type="checkbox" id="gyeongsang-do" name="area" class="checkbox" value="경상도"><label for="gyeongsang-do">경상도</label> <input type="checkbox" id="jeolla-do" name="area" class="checkbox" value="전라도"><label for="jeolla-do">전라도</label> <input type="checkbox" id="jeju-do" name="area" class="checkbox" value="제주도"><label for="jeju-do">제주도</label>
							</div>
						</div>
					</div>
				</div>
