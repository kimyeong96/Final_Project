...
<body>
		...
		<div class="row justify-content-center">
			...
			<div class="col-8 profiles">
				<div class="col-12" id="profileName">
					<strong>${memberdto.user_nickname}</strong> <span style="font-size: 15px">님</span>
				</div>
				<div class="col-12 p-2" id="totalCount">
					<i class="fa-solid fa-file-pen"></i> <span> 전체 게시글 : </span> <span>${totalBoardCount} 건</span>
				</div>
				<div class="col-12 p-2" id="boardCount">
					<i class="fa-solid fa-file-pen"></i> <span> 일반 게시글 : </span> <span>${selectBoardCount} 건</span>
				</div>
				<div class="col-12 p-2" id="roomCount">
					<i class="fa-solid fa-file-pen"></i> <span> 모임 게시글 : </span> <span>${selectGroupBoardCount} 건</span>
				</div>
			</div>
		</div>
	</div>
	...
	<div id="Wrapper">
		<div id="headWrapper" class="container">
			...
			<div id="head" class="row text-center align-items-center"></div>
		</div>
					...
					<form id="searchForm">
						<div class="row">
							<div class="col-12 mt-2" style="display: flex; justify-content: end;">
								<input class="d-none" type="text" id="user_email" value="${memberdto.user_email}"> <select class="form-select me-3" aria-label="Default select example" name="category" id="category" style="width: 100px;">
									<option value="board_all">전체</option>
									<option value="board_category">유형</option>
									<option value="board_title">제목</option>
								</select> <input type="text" name="keyword" class="form-control keyword me-3" placeholder="검색" style="width: 250px;">
						...
						<nav aria-label="Page navigation example">
							<ul class="pagination">
								<c:if test="${naviMap.needPrev eq true}">
									<li class="page-item"><a class="page-link" href="/mem/myWrite?curPage=${naviMap.startNavi-1}"><i class="fa-solid fa-angle-left"></i></a></li>
								</c:if>
								<c:forEach var="pageNum" begin="${naviMap.startNavi}" end="${naviMap.endNavi}">
									<li class="page-item"><a class="page-link" href="/mem/myWrite?curPage=${pageNum}">${pageNum}</a></li>
								</c:forEach>
								<c:if test="${naviMap.needNext eq true}">
									<li class="page-item"><a class="page-link" href="/mem/myWrite?curPage=${naviMap.endNavi+1}"><i class="fa-solid fa-angle-right"></i></a></li>
								</c:if>
							</ul>
						</nav>
					</div>
