...
<body>
		...
		<form action="/mem/modifyProfilePic" method="post" id="modifyPicForm" enctype="multipart/form-data">
			<div class="row justify-content-center">
				...
				<div class="col-8 profileBox" style="background-color: white;">
					...
					<div class="profileName">
						<span style="font-size: 20px"> <strong style="font-size: 25px; font-family: 'Mochiy Pop One', sans-serif;">${memberdto.user_nickname}</strong>님
						</span>
						<div class="statusMessage mt-2" id="statusMessage">
							<i class="fa-solid fa-quote-left"></i> <span>${memberdto.user_intro}</span> <i class="fa-solid fa-quote-right"></i>
						</div>
					</div>
					<table>
						<tbody>
			...
			<div class="row">
				<div class="col-md-8 modifyPro text-center" style="display: none;">
					<i class="fa-solid fa-folder-plus ms-5 me-3"></i> <span id="modifyProfilePic" style="cursor: pointer; user-select: none">프로필 사진 변경</span>
				</div>
				<div class="col-md-4"></div>
			</div>
			<div class="row">
				<div class="col-md-8 d-flex justify-content-center">
					<input type="file" class="form-control w-50 mt-2 d-none" id="file" name="user_image" accept='image/jpeg,image/gif,image/png'>
				</div>
				<div class="col-md-4 profileBtns justify-content-start" style="text-align: start; display: none">
					<c:choose>
						<c:when test="${loginType eq 'general'}">
							<button type="button" class="btn btn-outline-primary profileBtn me-3" data-bs-toggle="modal" data-bs-target="#exampleModal2">개인정보 수정</button>
						</c:when>
						<c:otherwise>
							<button type="button" class="btn btn-outline-primary profileBtn" id="profileModify">개인정보 수정</button>
						</c:otherwise>
					</c:choose>
					<button type="button" class="btn btn-outline-danger profileBtn ms-3" id="profileDelete">회원탈퇴</button>
					<input type="text" class="d-none" id="user_delete" value="${memberdto.user_delete}"> <input type="text" class="d-none" id="user_email" value="${memberdto.user_email}">
				</div>
			</div>
		</form>
	</div>
	...
	<div class="modal fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" style="z-index: 9999;">
		<div class="modal-dialog modal-dialog-centered d-flex justify-content-center">
			<div class="modal-content" style="width: 350px; height: 400px;">
				...
				<div class="modal-body">
					...
					<div class="row">
						<div class="col-5 d-flex justify-content-center" style="align-items: center; padding: 0px;">
							<label>현재 비밀번호 : </label>
						</div>
			...
			<div class="row body" style="margin: 0px;">
				<div class="col-lg-4 col-md-6 col-sm-12 d-flex justify-content-center mt-5">
					<div class="serviceBox color1 m-2">
						...
						<h3 class="title">
							선호지역(최대 3개 선택) <i class="fa-solid fa-pencil ms-3" data-bs-toggle="modal" data-bs-target="#exampleModal1" id="siteModify" style="cursor: pointer;"></i>
						</h3>
								...
								<div class="col" id="modal">
									<div class="row" style="height: 100%;">
										<div class="col-6 hobbyWrapper ps-2">
											...
											<div>
												<input onclick="CountChecked1(this)" type="checkbox" id="서울" name="site" class="checkbox me-1" value="서울"> <label for="서울">서울</label>
											</div>
											<div>
												<input onclick="CountChecked1(this)" type="checkbox" id="인천" name="site" class="checkbox me-1" value="인천"> <label for="인천">인천</label>
											</div>
											<div>
												<input onclick="CountChecked1(this)" type="checkbox" id="경기도" name="site" class="checkbox me-1" value="경기도"> <label for="경기도">경기도</label>
											</div>
											<div>
												<input onclick="CountChecked1(this)" type="checkbox" id="강원도" name="site" class="checkbox me-1" value="강원도"> <label for="강원도">강원도</label>
											</div>
										</div>
										<div class="col-6 hobbyWrapper">
											<div>
												<input onclick="CountChecked1(this)" type="checkbox" id="충정도" name="site" class="checkbox me-1" value="충정도"> <label for="충정도">충정도</label>
											</div>
											<div>
												<input onclick="CountChecked1(this)" type="checkbox" id="경상도" name="site" class="checkbox me-1" value="경상도"> <label for="경상도">경상도</label>
											</div>
											<div>
												<input onclick="CountChecked1(this)" type="checkbox" id="전라도" name="site" class="checkbox me-1" value="전라도"> <label for="전라도">전라도</label>
											</div>
											<div>
												<input onclick="CountChecked1(this)" type="checkbox" id="제주특별자치도" name="site" class="checkbox me-1" value="제주특별자치도"> <label for="제주특별자치도">제주도</label>
											</div>
										</div>
									</div>
								</div>
				...
				<div class="col-lg-4 col-md-6 col-sm-12 d-flex justify-content-center mt-5">
					<div class="serviceBox m-2 color2">
						...
						<h3 class="title">
							관심사(최대 3개 선택) <i class="fa-solid fa-pencil ms-3" data-bs-toggle="modal" data-bs-target="#exampleModal" id="hobbyModify" style="cursor: pointer;"></i>
						</h3>
					...
					<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
						<div class="modal-dialog modal-dialog-centered">
							<div class="modal-content">
								<div class="modal-header">
									<h5 class="modal-title" id="exampleModalLabel">관심사(최대 3개 선택)</h5>
									<button type="button" class="btn-close closeBtn" data-bs-dismiss="modal" aria-label="Close"></button>
								</div>
								<div class="modal-body">
									<div class="col" id="modal">
										<div class="row" style="height: 100%;">
											<div class="col-3 hobbyWrapper ps-2">
												<input type="text" class="d-none" id="user_email" value="${memberdto.user_email}">
												<div>
													<input onclick="CountChecked(this)" type="checkbox" id="아웃도어/여행" name="hobby" class="checkbox me-1" value="아웃도어/여행"> <label for="아웃도어/여행">아웃도어/여행</label>
												</div>
												<div>
													<input onclick="CountChecked(this)" type="checkbox" id="운동/스포츠" name="hobby" class="checkbox me-1" value="운동/스포츠"> <label for="운동/스포츠">운동/스포츠</label>
												</div>
												<div>
													<input onclick="CountChecked(this)" type="checkbox" id="외국어/언어" name="hobby" class="checkbox me-1" value="외국어/언어"> <label for="외국어/언어">외국어/언어</label>
												</div>
											</div>
											<div class="col-3 hobbyWrapper">
												<div>
													<input onclick="CountChecked(this)" type="checkbox" id="반려동물" name="hobby" class="checkbox me-1" value="반려동물"> <label for="반려동물">반려동물</label>
												</div>
												<div>
													<input onclick="CountChecked(this)" type="checkbox" id="음악/악기" name="hobby" class="checkbox me-1" value="음악/악기"> <label for="음악/악기">음악/악기</label>
												</div>
												<div>
													<input onclick="CountChecked(this)" type="checkbox" id="공예/만들기" name="hobby" class="checkbox me-1" value="공예/만들기"> <label for="공예/만들기">공예/만들기</label>
												</div>
											</div>
											<div class="col-3 hobbyWrapper">
												<div>
													<input onclick="CountChecked(this)" type="checkbox" id="댄스/무용" name="hobby" class="checkbox me-1" value="댄스/무용"> <label for="댄스/무용">댄스/무용</label>
												</div>
												<div>
													<input onclick="CountChecked(this)" type="checkbox" id="인문학/책/글" name="hobby" class="checkbox me-1" value="인문학/책/글"> <label for="인문학/책/글">인문학/책/글</label>
												</div>
												<div>
													<input onclick="CountChecked(this)" type="checkbox" id="사진/영상" name="hobby" class="checkbox me-1" value="사진/영상"> <label for="사진/영상">사진/영상</label>
												</div>
											</div>
											<div class="col-3 hobbyWrapper">
												<div>
													<input onclick="CountChecked(this)" type="checkbox" id="게임/오락" name="hobby" class="checkbox me-1" value="게임/오락"> <label for="게임/오락">게임/오락</label>
												</div>
												<div>
													<input onclick="CountChecked(this)" type="checkbox" id="요리/제조" name="hobby" class="checkbox me-1" value="요리/제조"> <label for="요리/제조">요리/제조</label>
												</div>
												<div>
													<input onclick="CountChecked(this)" type="checkbox" id="문화/공연/축제" name="hobby" class="checkbox me-1" value="문화/공연/축제"> <label for="문화/공연/축제">문화/공연/축제</label>
												</div>
											</div>
										</div>
									</div>
				...
				<div class="col-lg-4 col-md-6 col-sm-12 d-flex justify-content-center mt-5 d-flex justify-content-center">
							...
							<c:forEach items="${selectGroupList}" var="Groupdto">
								<c:if test="${Groupdto.access eq '주최자'}">
									<div class="row description" style="color: #008A65;">
										<div class="col-3 d-flex justify-content-end" style="padding: none;">
											<i class="fa-solid fa-crown " style="color: gold;"></i>
										</div>
										<div class="col-7 d-flex justify-content-start text-start">
											<span style="word-break: break-all;"> <a href="/group/toGroupDetail?seq_group=${Groupdto.SEQ_GROUP}" style="padding: 0px;">${Groupdto.TITLE}</a>
											</span>
										</div>
										<div class="col-2"></div>
									</div>
								...
								<c:if test="${Groupdto.access eq '멤버'}">
									<div class="row description" style="color: #008A65;">
										...
										<div class="col-7 d-flex justify-content-start text-start">
											<span><a href="/group/toGroupDetail?seq_group=${Groupdto.SEQ_GROUP}" style="padding: 0px;">${Groupdto.TITLE}</a></span>
										</div>
										<div class="col-2"></div>
									</div>
								</c:if>
				...
				<div class="col-lg-4 col-md-6 col-sm-12 d-flex justify-content-center mt-5">
					<div class="serviceBox color2 m-2">
						...
						<c:if test="${selectBoardList.size() > 0}">
							<c:forEach items="${selectBoardList}" var="boarddto" varStatus="status" begin="0" end="3">
								<div class="row description" style="color: #27436d;">
									<div class="col-3 d-flex justify-content-end">
							...
							<div class="myWrite mt-3">
								<span class="towritePage" id="towritePage" style="color: #27436d;">더보기 <i class="fa-solid fa-arrow-right"></i>
								</span>
							</div>
						</c:if>
					</div>
							...
							<c:forEach items="${selectWishList}" var="wishlistdto" begin="0" end="2">
								<div class="row description" id="wishBox" style="color: #008A65;">
									...
									<div class="col-3 d-flex justify-content-start">
										<i class="fa-solid fa-trash-can wishDelete"></i> <input type="text" id="seq_group" class="seq_group d-none" value="${wishlistdto.SEQ_GROUP}">
									</div>
								</div>
							</c:forEach>
						</c:if>
				...
				<div class="col-lg-4 col-md-6 col-sm-12 d-flex justify-content-center mt-5">
					<div class="serviceBox m-2 color2">
						...
						<div class="d-flex myMsg" style="color: #27436d;">
							<span class="checkMyMsg" data-bs-toggle="modal" data-bs-target="#staticBackdrop">내 쪽지 관리하기 <i class="fa-solid fa-arrow-right"></i></span>
						</div>
					</div>
				</div>
				<!-- Modal -->
					...
					<div class="modal-lg justify-content-center modal-dialog modal-dialog-scrollable modal-dialog-centered">
						<div class="modal-content">
							<div class="modal-header" style="background-color: #FFFEE9; border-bottom: 2px solid #FFE19E;">
								<span id="staticBackdropLabel" style="font-size: 16px;"> <img style="width: 35px;" src="/resources/images/mail.png">
								</span> <span class="ms-2" id="msgTitle">쪽지함보기</span>
								<button type="button" class="btn-close" data-bs-dismiss="modal" onclick="moveSite();" aria-label="Close"></button>
							</div>
							<!-- 답장 (보낸사람 클릭시 활성화 -->
							<div class="d-none" id="msgForm" style="padding: 14px;">
								<div class="row">
									<div class="col-md-12">
										<div>
											<i class="fa-solid fa-envelope"></i><span class="ms-2">받는 사람</span>
										</div>
								...
								<div class="row mt-2">
									<div class="col-md-12">
										<div>
											<i class="fa-solid fa-comment"></i><span class="ms-2">답장 내용</span>
										</div>
							...
							<div class="row mt-2" id="msgSelect">
								<div class="col-md-12 d-flex">
									<div class="msgReceive d-flex justify-content-center ms-2" style="background-color: #FFECC2">
										<span class="receiveBtn"><i class="fa-solid fa-check"></i></span><span class="ms-1">받은 쪽지함</span>
									</div>
									<div class="msgSend d-flex justify-content-center" style="margin-left: 10px;">
										<span class="sendBtn d-none"><i class="fa-solid fa-check"></i></span><span class="ms-1">보낸 쪽지함</span>
									</div>
								</div>
							</div>
							<div class="modal-body">
							...
							<div class="modal-footer msgModal-footer" style="background-color: #FFFEE9; border-top: 2px solid #FFE19E;">
								<button type="button" class="btn btn-primary ms-2" id="closeBtn" onclick="moveSite();" data-bs-dismiss="modal">닫기</button>
