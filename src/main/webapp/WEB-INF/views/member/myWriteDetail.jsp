	...
	<div class="container my-5 py-5">
		...
		<div class="row mt-4 justify-content-between align-items-center" id="board-head-row">
			<div class="col-auto" id="board-head-col">
				<i class="fa-regular fa-clock me-3"> ${detail.boardDTO.board_date}</i> <i class="fa-regular fa-font-awesome me-3"> ${detail.boardDTO.board_count}</i> <i class="fa-regular fa-comment-dots"> ${detail.commentCnt}</i>
			</div>
