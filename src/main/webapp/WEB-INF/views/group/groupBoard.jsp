			...
			<div class="row" id="contentRow">
				...
				<div id="content-body" class="col-10">
									...
									<c:choose>
										...
										<c:otherwise>
											<c:forEach items="${noticeList}" var="notice">
												<tr>
													<td class="col-2"><i class="fa-solid fa-bullhorn"></i></td>
													<td class="col-5 text-start"><a class="move" href="${notice.seq_group_board}"> ${notice.gboard_title} </a></td>
											...
											<c:forEach items="${list}" var="dto">
												<tr>
													...
													<td class="col-5 text-start"><a class="move" href="${dto.seq_group_board}"> ${dto.gboard_title} </a></td>
						...
						<div class="pageInfo_area">
							<ul id="pageInfo" class="pageInfo pagination justify-content-center">
								...
								<c:if test="${pageMaker.prev}">
									<li class="pageInfo_btn previous page-item"><a class="page-link" href="${pageMaker.startPage-1}"> <i class="fa-solid fa-angle-left"></i>
									</a></li>
								</c:if>
								...
								<c:if test="${pageMaker.next}">
									<li class="pageInfo_btn next page-item"><a class="page-link" href="${pageMaker.endPage + 1 }"> <i class="fa-solid fa-angle-right"></i>
									</a></li>
								</c:if>
							</ul>
						</div>
					...
					<form id="moveForm" method="get">
						<input type="hidden" name="seq_group" value="${pageMaker.cri.seq_group}"> <input type="hidden" name="pageNum" value="${pageMaker.cri.pageNum}"> <input type="hidden" name="amount" value="${pageMaker.cri.amount}"> <input type="hidden" name="keyword" value="${pageMaker.cri.keyword}"> <input type="hidden" name="type" value="${pageMaker.cri.type}"> <input type="hidden" name="category" value="${pageMaker.cri.category}">
					</form>
	...
	<script>
		...
		$(".move").on(
				...
				function(e) {
					...
					$("#moveForm").append(
							"<input type='hidden' name='seq_group_board' id = 'seq_gboardInput' value='"
									+ $(this).attr("href") + "'>");
