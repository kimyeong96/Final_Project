					...
					<div class="container">
						<div class="row d-flex">
							...
							<div class="col-2 d-flex">
								<button type=" button" class="" id="wishListBtn" style="border: 0; outline: 0; background-color: #fff; font-size: 24px;">
									<i class="fa-regular fa-heart"></i>
								</button>
								<button type=" button" class="d-none" id="wishCancelBtn" style="border: 0; outline: 0; color: red; background-color: #fff; font-size: 24px;">
			...
			<div class="col-sm-12 col-md-5 mt-4">
				<div class="row" style="padding: 34px; padding-top: 0px;" stlye="position : relative;">
							...
							<div class="groupTitleHeaderImgBox">
								<c:choose>
									<c:when test="${mapList.TableJoinDTO[0].user_image ne null}">
										<img src="/profile/${mapList.TableJoinDTO[0].user_image}" id="profile_image">
									</c:when>
									<c:otherwise>
						...
						<div class="d-flex flex-column justify-content-center" style="padding: 4px; font-family: InfinitySans-RegularA1;">
							...
							<div class="mt-3" style="border-top: 1px solid #e0e3e8;">
								<div class="d-flex align-items-center justify-content-center mt-3 joinContainer">
									<button type=" button" class="btn btn-primary ms-2 d-none mt-2 groupControllBtn" style="width: 90%;" id="quitGroupBtn">모임 탈퇴하기</button>
									<button type=" button" class="btn btn-primary ms-2 mt-2 groupControllBtn" style="width: 90%;" id="joinGroupBtn">모임 가입하기</button>
								</div>
							</div>
					...
					<div class="row mt-2" id="hiddenGroupInfo">
						...
						<div class="mt-3" style="border-top: 1px solid #e0e3e8;">
							<div class="d-flex align-items-center justify-content-center mt-3 joinContainer">
								<button type=" button" class="btn btn-primary ms-2 d-none" style="width: 90%;" id="quitGroupBtn">모임 탈퇴하기</button>
								<button type=" button" class="btn btn-primary ms-2" style="width: 90%;" id="joinGroupBtn">모임 가입하기</button>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="col-md-7" style="border-top: 1px solid #e0e3e8;">
						<div class="mt-3">
							...
							<div class="groupMemberrInfo">
								...
								<div class="row mt-2">
									<c:forEach items="${mapList.TableJoinDTO}" var="list" begin="0" end="${fn:length(memberList)}">
					...
					<div class="justify-content-center modal-dialog modal-dialog-centered">
						<div class="modal-content">
							...
							<div class="modal-body">
									...
									<div class="col-md-8 modalProfileInfo">
										<div class="modalProfileName">
											<div class="mt-1" style="font-size: 20px;">
												<span id="profileName"></span>(<span id="profileNickname"></span>) <span id="siren_icon"><img src="/resources/images/group/siren_icon.png"></span>
											</div>
											<div class="mt-1" style="font-size: 14px;">회원</div>
										</div>
										<div class="modalProfileGender d-flex" style="font-size: 14px;">
											<div>
												<i class="fa-solid fa-location-dot"></i><span class="ms-1">지역 : </span><span id="profileLocation"></span>
											</div>
											<div class="ms-3">
												<i class="fa-solid fa-mars-and-venus"></i><span class="ms-1">성별 : </span><span id="profileGender"></span>
											</div>
										</div>
								...
								<div class="d-none" id="msgForm">
									<div class="row">
										<div class="col-md-12">
											<div>
												<i class="fa-solid fa-envelope"></i><span class="ms-2">받는 사람</span>(<span id="receiverName"></span>)
											</div>
									...
									<div class="row mt-2">
										<div class="col-md-12">
											<div>
												<i class="fa-solid fa-comment"></i><span class="ms-2">쪽지 내용</span>
											</div>
								...
								<div class="d-none" id="reportForm">
									<div class="row">
										<div class="col-md-12">
											...
											<input type="text" class="form-control mt-2" id="report_receive" readonly>
										</div>
									</div>
									<div class="row mt-2">
										<div class="col-md-12">
											...
											<textarea class="form-control mt-2" id="reportContent" rows="3" style="resize: none;"></textarea>
										</div>
									</div>
								</div>
							</div>
							<div class="modal-footer">
								...
								<button type="button" class="btn btn-danger d-none closeXmark" id="reportBtn">신고하기</button>
							</div>
							<input type="text" value="" id="send_email" class="d-none"> <input type="text" value="" id="receive_email" class="d-none">
						</div>
					</div>
				</div>
			</div>
