...
<body>
	...
	<div class="container" id="modifyWrapper" style="width: 70%;">
		...
		<form id="modifyForm" action="/Gboard/modify" method="post">
			...
			<div class="d-none">
				<input type="text" id="seq_group_board" name="seq_group_board" value="${modMap.boardDTO.seq_group_board}"> <input type="text" id="seq_group" name="seq_group" value="${modMap.boardDTO.seq_group}">
			</div>
