...
<body>
	...
	<div class="container-content mt-5 py-5">
		<div class="row content-delete m-auto py-5">
			<div class="col-md-6">
				<p style="font-size: 40px; font-family: 'Do Hyeon', sans-serif;">모임을 해산하시겠습니까?</p>
				<br>
				<p class="text text-muted light-300" style="font-size: 20px; font-family: 'Do Hyeon', sans-serif;">
					모임 해산시 해당 정보는 되돌릴 수 없습니다.<br> <br> 1) 해당 모임의 활동 기록은 사라집니다.<br> <br> 2) 모임에 속해있던 모임원들은 자동으로 모임에서 탈퇴됩니다.<br> <br> 3) 모임에서 작성한 게시글 및 일정은 더이상 볼 수 없습니다.<br> <br> 4) 모임해산은 되돌릴 수 없습니다.
				</p>
			</div>
