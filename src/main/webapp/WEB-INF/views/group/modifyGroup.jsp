...
<body>
	...
	<div class="container w-75 mainContainer">
		<form action="/group/modifyGroup" method="post" enctype="multipart/form-data" id="groupForm">
			<!--관심사 -->
			<div class="row style mt-4">
				...
				<div class="col-9 mainTextInterest d-flex flex-column justify-content-start">
					...
					<span style="font-family: InfinitySans-RegularA1; font-size: 14px;">주제가 구체적일수록 비슷한 관심사를 가진 사람들에게 그룹을 <br>홍보하기가 더 쉬워집니다. 주제는 1개만 선택 가능합니다.<br> <br> 기존에 선택하셨던 주제는 <strong style="color: red;">${tbl_group_dto.group_category}</strong> 입니다.
					</span>
					<div class="row mt-4">
						<div class="col-md">
					...
					<div class="row mt-2">
						<div class="col">
							...
							<input type="text" name="group_category" id="group_category" value="${tbl_group_dto.group_category}" hidden>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row style mt-5">
				...
				<!--기본 글쓰기 -->
				<div class="col-md-9 mainTextBasicInfo d-flex flex-column justify-content-start">
					<h4 style="font-family: katuri;">Basic Info</h4>
					<strong style="font-family: InfinitySans-RegularA1;"mt-2">모임 이름</strong> <span style="font-family: InfinitySans-RegularA1; font-size: 14px;" class="mt-2">사람들이 그룹의 성격과 내용을 파악할 수 있는 이름을 지어주세요. 떠오르는 기발한 이름이 있나요? <br> 마음이 바뀌면 나중에 다시 변경할 수 있습니다.
					</span>
					<div class="mb-3 mt-2">
						<input type="text" class="form-control" id="group_title" placeholder="최대 24자까지 작성 가능합니다." name="group_title" maxlength='24' value="${tbl_group_dto.group_title}">

					</div>
					<strong style="font-family: InfinitySans-RegularA1;" class="mt-2">모집 내용</strong> <span style="font-size: 14px; font-family: InfinitySans-RegularA1;" class="mt-2">모집내용은 회원들에게 그룹을 홍보할 때 표시됩니다. <br>변경사항이 있다면 나중에 언제든지 업데이트가 가능합니다.
					</span>
			...
			<div class="row style mt-5">
				...
				<div class="col-9 mainText mainTextMap d-flex flex-column justify-content-start">
					...
					<span style="font-family: InfinitySans-RegularA1; font-size: 14px;">해당 지역의 사람들이 귀하의 이벤트를 발견하도록 돕고 <br> 참석자들에게 위치를 제공해주세요.<br> <br> 기존에 선택하셨던 위치는 <strong style="color: red;">${tbl_group_dto.group_site}</strong> 입니다.
					</span> <span class="mt-2" style="font-family: InfinitySans-RegularA1;"><strong>새로운 지역 설정</strong></span>
					<div class="selectBox d-flex">
						<select class="form-select mt-2 w-25 me-2" name="sido1" id="sido1" onchange="selectBoxChange1(this.value);"></select> <select class="form-select mt-2 w-25" name="gugun1" id="gugun1" onchange="selectBoxChange2(this.value);"></select>
						<button type="button" class="btn btn-primary mt-2 group_siteBtn ms-3">지역 선택 완료</button>
					</div>
					<!--모임 지역-->
					<input type="text" id="group_site" name="group_site" value="${tbl_group_dto.group_site}" hidden> <input type="text" id="sido1Input" name="sido1Input" hidden> <input type="text" id="gugun1Input" name="gugun1Input" hidden>
				</div>
			</div>
			...
			<div class="row style mt-5">
				...
				<div class="col-9 mainTextFile d-flex flex-column justify-content-start">
					...
					<span style="font-family: InfinitySans-RegularA1; font-size: 14px;">썸네일로 보여질 이미지입니다. <br>본인이 생각하는 최고의 사진을 넣어주세요!
					</span>
					<div class="row">
						<div class="col-md-9 imgBox mt-4">
							<c:choose>
								<c:when test="${tbl_group_dto.sys_name ne null}">
									<img src="/group_profile/${tbl_group_dto.sys_name}" id="profile_image" style="width: 100%; height: 400px;">
								</c:when>
								<c:otherwise>
					...
					<input type="file" class="form-control mt-3 w-75" name="groupFile" id="groupFile" accept='image/jpeg,image/gif,image/png' />
				</div>
			</div>
			...
			<div class="row style mt-5">
				...
				<!--위치 설정-->
				<div class="col-md-9 mainText mainTextMap d-flex flex-column justify-content-start">
					<h4 style="font-family: Katuri;">Member</h4>
					<span style="font-family: InfinitySans-RegularA1; font-size: 14px;">인원수를 조정을 통해 유동적인 모임을 생성하세요!<br> 인원은 최소 2명부터 최대 10명까지 가능합니다.<br> <br> 현재 모임의 맴버수는 <strong style="color: red;">${fn:length(memberList)}명</strong> 입니다.
					</span> <strong class="mt-3">인원 설정</strong>
					<div class="memberCntBox d-flex mt-2 ">
						<div class="calBtn minusBtn d-flex justify-content-center align-items-center" id="minusBtn">
							<i class="fa-solid fa-minus" style="font-size: 14px;"></i>
						</div>
						<div class="memberCnt d-flex justify-content-center align-items-center">${tbl_group_dto.group_people}</div>
						<div class="calBtn plusBtn d-flex justify-content-center align-items-center" id="plusBtn">
							<i class="fa-solid fa-plus" style="font-size: 14px;"></i>
						</div>
					</div>
					<input type="text" name="group_people" id="group_people" value="${tbl_group_dto.group_people}" hidden>
				</div>
			</div>
			<!--이미지-->
			<div class="row style mt-5">
				...
				<div class="col-md-9 mainTextFile d-flex flex-column justify-content-start">
					...
					</span> <span style="font-size: 14px; font-family: InfinitySans-RegularA1;" class="mt-2">끼리끼리는 끈끈한 커뮤니티를 통해 사람들이 더욱 풍요롭고 행복한 삶을 <br>살 수 있도록 합니다. 따라서 모든 그룹은 다음 사항을 충족해야 합니다.
					</span>
					<ul class="mt-2" style="font-size: 14px;">
						<li><i class="fa-solid fa-check"></i><span class="ms-3" style="font-family: InfinitySans-RegularA1;">회원에게 성장의 기회 제공</span></li>
						<li><i class="fa-solid fa-check"></i><span class="ms-3" style="font-family: InfinitySans-RegularA1;">모든 이벤트에 주최자 참석</span></li>
						<li><i class="fa-solid fa-check"></i><span class="ms-3" style="font-family: InfinitySans-RegularA1;">그룹의 목적은 투명하게 공개</span></li>
					</ul>
				</div>
			</div>
		</form>
