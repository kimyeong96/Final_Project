						...
						<tbody class="tbody">
							<c:forEach items="${memList.TableJoinDTO}" var="list">
								<tr class="tr">
									...
									<td class="col-md"><input class="form-check-input checkAccess" type="checkbox" id="checkAccess" name="checkAccess" value="${list.access}"></td>
									<td class="col-md"><input class="form-check-input checkUser_email" id="checkUser_email" type="checkbox" name="checkUser_email" value="${list.user_email}"></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
