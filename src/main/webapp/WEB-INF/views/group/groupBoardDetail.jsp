	...
	<div id="detail" class="container my-5 py-5">
		...
		<div class="row mt-4 justify-content-between align-items-center">
			<div class="col-auto" id="board-head-col">
				<i class="fa-regular fa-clock"></i> <span class="me-3">${detail.boardDTO.written_date}</span> <i class="fa-regular fa-font-awesome"></i> <span class="me-3">${detail.boardDTO.view_count}</span> <i class="fa-regular fa-comment-dots"></i> <span class="me-3">${detail.commentCnt}</span> <i class="fa-regular fa-heart"></i> <span>${like.likeHit}</span>
			</div>
		...
		<form id="commentForm" action="/comment/writeG" method="post">
			<div class="row mt-4 p-0 py-3" style="background-color: #ECECEC; border-radius: 10px">
				<input class="d-none" id="seq_group" name="seq_group" value="${detail.boardDTO.seq_group}"> <input class="d-none" id="seq_board" name="seq_group_board" value="${detail.boardDTO.seq_group_board}">
				<div class="col-10">
		...
		<form id="infoForm" method="get">
			<input type="hidden" id="seq_group" name="seq_group" value="${detail.boardDTO.seq_group}"> <input type="hidden" id="seq_group_board" name="seq_group_board" value="${detail.boardDTO.seq_group_board}"> <input type="hidden" name="pageNum" value='<c:out value="${cri.pageNum}"/>'> <input type="hidden" name="amount" value='<c:out value="${cri.amount}"/>'> <input type="hidden" name="type" value="${cri.type}"> <input type="hidden" name="keyword" value="${cri.keyword}">
		</form>
	</div>
