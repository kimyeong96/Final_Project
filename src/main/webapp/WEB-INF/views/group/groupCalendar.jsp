		...
		<div id="main" class="row my-2 d-flex justify-content-center pb-5">
			<div class="inner col-md-8 col-12">
				...
				<section class="row d-flex justify-content-end gy-4 gx-md-5 mb-md-5 mt-md-2">
						...
						<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
							<div class="modal-content">
								<div class="modal-header text-center">
									...
									<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" onclick="moveSite();"></button>
								</div>
								<div class="modal-body">
									<form id="calForm" name="calForm" action="/calForm" method="post">
										<div class="form-floating mb-3 partyCal" style="margin-left: 10%;">
											<input type="text" class="form-control" id="title" name="title" maxlength='30' placeholder="최대 30자까지 가능합니다"> <label for="partyTitle">제목</label>
										</div>
										<div class="form-floating mb-3 partyCal" style="margin-left: 10%;">
											<input type="text" class="form-control" id="showDate" name="showDate" disabled> <label for="partyDate">모임날짜</label> <input type="text" name="start" id="start" hidden> <input type="text" name="end" id="end" hidden>
										</div>
										<div class="mb-3 partyCal d-flex flex-column timeContainer" style="margin-left: 10%; margin-right: 10%; height: 56px; width: 376px;">
										...
										<div class="mb-3 partyCal d-flex flex-column groupDefaultTimeContainer" style="margin-left: 10%; margin-right: 10%; height: 56px; width: 376px; background-color: rgb(233, 236, 239);">
											<div class="mt-1" style="color: #8793a1; font-size: 13px; margin-left: 11px;">시간</div>
										...
										<!-- 시간 넘기기 input  -->
										<input type="text" id="hourInput" value="00" name="hour" hidden> <input type="text" id="minInput" value="00" name="min" hidden>
										<div class="form-floating mb-3 partyCal" style="margin-left: 10%;">
											<input type="text" class="form-control" id="gcal_content" placeholder="최대 30자까지 가능합니다" name="gcal_content" maxlength='30'> <label for="partyContent">내용</label>
										</div>
										<div class="form-floating mb-3 partyCal" style="margin-left: 10%;">
											<input type="text" class="form-control keyword" id="partyLocation" placeholder="장소 검색"> <label for="partyLocation" id="placeholderForSearch">&#128270; 장소를 입력하시고 엔터키를 눌러주세요!</label>
										</div>
										...
										<!-- 카카오맵 기본 좌표 kh 당산 -->
										<input type="hidden" name="xcoord" id="xcoord" value="126.896761296215" /> <input type="hidden" name="ycoord" id="ycoord" value="37.5339071790577" /> <input type="hidden" name="placeName" id="placeName" value="강남" /> <input type="hidden" name="seq_group_cal" id="seq_group_cal" value="" />
									</form>
					...
					<!-- Calendar 일정 생성기-->
					<div class="" id='external-events'></div>
					<!--캘린더 자체 생성-->
					<div class="col-md-12 col-auto flex-fill" id='calendar' style="min-width: initial; min-height: 60vh;"></div>
					<!-- Calendar end -->
				</section>
			</div>
		</div>
