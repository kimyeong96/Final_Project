							...
							<div class="col-auto user">
								<c:if test="${not empty loginSession && loginSession.user_email eq 'admin'}">
									<div class="dropdown text-end">
										<a href="/" class="d-block link-dark text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false"> <img src="/resources/images/profile.jpg" alt="mdo" width="40" height="40" class="rounded-circle">
										</a>
		...
		<div id="privacyForm">
			<div class="row ">
				<div class="col d-flex align-items-center">
					<input type="checkbox" name="checkboxAll"> <label for="allCheck">끼리끼리 이용약관, 개인정보 수집 및 이용에 모두 동의합니다.</label>
				</div>
			</div>
			<div class="row mb-0">
				<div class="col d-flex align-items-center">
					<input type="checkbox" name="essential" id="termsService"> <label for="termsService">끼리끼리 이용약관 동의(필수)</label>
				</div>
			</div>
			<div class="row mt-2 mb-2">
				<div class="col d-flex align-items-center">
					<div class="term w-100">여러분을 환영합니다. 끼리끼리 서비스 및 제품(이하 ‘서비스’)을 이용해 주셔서 감사합니다. 본 약관은 다양한 끼리끼리 서비스의 이용과 관련하여 끼리끼리 서비스를 제공하는 끼리끼리 주식회사(이하 끼리끼리)와 이를 이용하는 끼리끼리 서비스 회원(이하 ‘회원’) 또는 비회원과의 관계를 설명하며, 아울러 여러분의 끼리끼리 서비스 이용에 도움이 될 수 있는 유익한 정보를 포함하고 있습니다. 끼리끼리 서비스를 이용하시거나 끼리끼리 서비스 회원으로 가입하실 경우 여러분은 본 약관 및 관련 운영 정책을 확인하거나 동의하게 되므로, 잠시 시간을 내시어 주의 깊게 살펴봐 주시기 바랍니다.</div>
				</div>
			</div>

			<div class="row mb-0">
				<div class="col d-flex align-items-center">
					<input type="checkbox" name="essential" id="termsPrivacy"> <label for="termsPrivacy">개인정보 수집 및 이용 동의(필수)</label>
				</div>
			</div>
			<div class="row mt-2 mb-2">
				<div class="col d-flex align-items-center">
					<div class="term w-100">개인정보보호법에 따라 끼리끼리에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및 이용목적, 개인정보의 보유 및 이용기간, 동의 거부권 및 동의 거부 시 불이익에 관한 사항을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다.1. 수집하는 개인정보 이용자는 회원가입을 하지 않아도 정보 검색, 뉴스 보기 등 대부분의 끼리끼리 서비스를 회원과 동일하게 이용할 수 있습니다. 이용자가 메일, 캘린더, 카페, 블로그 등과 같이 개인화 혹은 회원제 서비스를 이용하기 위해 회원가입을 할 경우, 끼리끼리는 서비스 이용을 위해 필요한 최소한의 개인정보를 수집합니다.</div>
				</div>
			</div>
