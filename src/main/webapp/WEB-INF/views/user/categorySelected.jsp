...
<body>
								...
								<div class="row" style="height: 600px;">
									<div class="col-sm-12 col-md-12 d-flex flex-column align-items-center justify-content-center">
										<div>
											<div>
												<h3>
													현재 해당 카테고리는 그룹이 존재하지 않습니다.
													<h3>
											</div>
											<div style="font-size: 18px;">자신이 모임장이 되어서 취미를 공유하고 모임 일정을 통해 즐거운 만남과, 모임 게시판, 모임 채팅을 활용하여 다양한 이야기와 취미활동을 공유하세요.</div>
	...
	<script>
		...
		$('#locationBtn').on("click", function() {
			...
			$('.locationBtn').children().eq(1).css({
				'background-color' : '#8D9EE0',
				'color' : 'white'
			});
			$('.categoryBtn').children().eq(1).css({
				'background-color' : 'white',
				'color' : '#8D9EE0'
			});
		});
