	...
	<div class="container">
		...
		<div class="topimg row">
			...
			<div class="txtBox col-md-6 d-flex flex-column align-items-center justify-content-center">
				...
				<div class="mt-3 w-75">올해 하고 싶은 취미가 무엇이든 끼리끼리가 도와드릴 수 있습니다. 이제부터 사람들과 취미에 대해 이야기하고 싶다면 '끼리끼리'를 찾아주세요. 매일 많은 사람들과 소통하고 싶다면 가입하여 즐거운 시간을 보내세요.</div>
				<div class="mt-4 w-75">취미가 없고 지루한 일상이 싫다면 모임을 가입하세요. 즐거운 모임으로 새로운 세상을 찾아요.</div>
				<div class="mt-4">
					<div class="button">
		...
		<div class="row mt-5">
			<div class="col-md-12 text-center">
				...
				<p>
					온라인과 대면 이벤트를 통해 관심사를 공유할 새로운 사람들을 만나보세요.<br>계정을 무료로 생설할 수 있습니다.
				</p>
			</div>
		</div>
					...
					<c:if test="${boardList ne null}">
						<div class="col-xl-6 text-end px-5">
							...
							<div class="text-start">
								<img src="/resources/images/gold.png" style="width: 80px;"> <span style="font-size: 45px; font-family: 'SDSamliphopangche_Outline';"> BEST LIKES </span>
							</div>
							<div class="fs-4">
								<i class="fa-regular fa-heart" style="color: red"></i> <span class="me-3">${boardList.get(0).likehit }</span> <i class="fa-regular fa-eye" style="color: gray"></i> <span>${boardList.get(0).board_count }</span>
							</div>
				...
				<div class="row g-0 mt-5 align-items-center">
					...
					<c:if test="${boardList.size()>=2}">
						...
						<div class="col-xl-6 ms-auto pe-5 px-5">
							<div>
								<img src="/resources/images/silver.png" style="width: 80px;"> <span style="font-size: 45px; font-family: 'SDSamliphopangche_Outline';"> BEST LIKES </span>
							</div>
							<div class="fs-4 mt-2 text-end">
								<i class="fa-regular fa-heart" style="color: red"></i> <span class="me-3">${boardList.get(1).likehit }</span> <i class="fa-regular fa-eye" style="color: gray"></i> <span>${boardList.get(1).board_count }</span>
							</div>
				...
				<div class="col-md-7 d-flex align-items-center justify-content-center">
					<div class="phoneTextBox d-flex flex-column justify-content-center align-items-center mt-2">
						<div class="downloadHead">
							<h1>
								<span style="font-size: 50px; color: #4285f4;">끼</span><span style="font-size: 50px; color: #9e9e9e;">리</span><span style="font-size: 50px; color: #4285f4;">끼</span><span style="font-size: 50px; color: #9e9e9e;">리</span> 모바일 앱 출시!
							</h1>
						</div>
						...
						<div class="downloadContent">
							<label><strong style="font-size: 30px;">남은 시간</strong><br></label> <strong id="sample01" style="color: red"></strong>
						</div>
						<div class="downloadBtn mt-3 d-flex">
							<div class="row appBox">
								...
								<div class="col-8 appBoxText d-flex flex-column justify-content-center" style="color: #fff;">
							...
							<c:forEach items="${selectAllList}" var="dto" begin="0" end="5">
								<div class="col-md-4 d-flex justify-content-center p-4">
									<div class="card" data-aos="flip-up" data-aos-duration="1000">
										...
										<div class="card-body">
											<div class="card-text-category d-flex justify-content-center align-items-center" style="color: #fff;">${dto.group_category}</div>
							...
							<c:forEach items="${selectNewList}" var="dto" begin="0" end="5">
								<div class="col-md-4 d-flex justify-content-center p-4">
									<div class="card" data-aos="flip-up" data-aos-duration="1000">
										...
										<span class="d-none  seq_group">${dto.seq_group}</span>
										<div class="card-body">
											<div class="card-text card-text-category d-flex justify-content-center align-items-center" style="color: #fff;">${dto.group_category}</div>
											<div class="card-text mt-1">
												<strong>${dto.group_title}</strong>
											</div>
